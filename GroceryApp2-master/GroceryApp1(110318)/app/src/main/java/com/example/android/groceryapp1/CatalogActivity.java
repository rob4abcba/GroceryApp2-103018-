...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    private void insertGrocery() {
        ...
        values.put ( GroceryContract.GroceryEntry.COLUMN_GROCERY_NAME, getString( R.string.inset_dummy_grocery_name) );
        values.put ( GroceryContract.GroceryEntry.COLUMN_GROCERY_PRICE, getString( R.string.insert_dummy_grocery_price) );
        values.put ( GroceryContract.GroceryEntry.COLUMN_GROCERY_QUANTITY, getString( R.string.insert_dummy_grocery_qty) );
        values.put ( GroceryContract.GroceryEntry.COLUMN_GROCERY_SUPPLIER_NAME, getString( R.string.insert_dummy_grocery_supname) );
        values.put ( GroceryContract.GroceryEntry.COLUMN_GROCERY_SUPPLER_PHONE, getString( R.string.insert_dummy_grocery_supphone) );
    ...
    private void deleteAllGrocery() {
        ...
        Log.v ( "CatalogActivity", rowsDeleted + " rows deleted from grocery database" );
    }
    @Override
