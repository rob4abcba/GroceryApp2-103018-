...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        suppPhnBtn.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                Log.v("EditText", mSupplierPhoneEditText.getText().toString().trim ());
            }
        } );
       ...
       mIncreaseQtyBtn.setOnClickListener ( new View.OnClickListener () {
           @Override
           public void onClick(View v) {
    ...
    private void saveGrocery() {
        ...
        int quantityInt = Integer.parseInt ( qtyString );
